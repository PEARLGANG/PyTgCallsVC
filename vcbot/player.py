...
class Player:
    ...
    async def join_play(self, video, audio, width=854, height=480, fps=20, bitrate=48000):
    ...
    async def change_source(self, video, audio, width=854, height=480, fps=20, bitrate=48000):
