...
class Player:
    ...
    async def join_play(self, video, audio, width=1920, height=1080, fps=20, bitrate=45000):
    ...
    async def change_source(self, video, audio, width=1920, height=1080, fps=20, bitrate=45000):
